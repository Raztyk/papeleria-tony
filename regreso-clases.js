// Funciones específicas para la página de Regreso a Clases
document.addEventListener('DOMContentLoaded', function() {
    // Inicializar filtros
    initFilters();
    
    // Inicializar pestañas de paquetes escolares
    initPackageTabs();
    ...
    console.log('Página de Regreso a Clases cargada');
});
...
// Función para inicializar las pestañas de paquetes escolares
